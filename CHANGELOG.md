...
- Bump [blackduck-inc/black-duck-security-scan](https://github.com/blackduck-inc/black-duck-security-scan) from 2.0.0 to 2.7.0 ([#91](https://github.com/PreFrontalCorporate/gaia/pull/91))
