...
- Bump [google/osv-scanner-action/.github/workflows/osv-scanner-reusable-pr.yml](https://github.com/google/osv-scanner-action) from 1.7.1 to 2.3.3 ([#99](https://github.com/PreFrontalCorporate/gaia/pull/99))
