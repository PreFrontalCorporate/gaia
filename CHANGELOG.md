...
- Bump [SonarSource/sonarqube-scan-action](https://github.com/sonarsource/sonarqube-scan-action) from 1.1.0 to 7.0.0 ([#95](https://github.com/PreFrontalCorporate/gaia/pull/95))
