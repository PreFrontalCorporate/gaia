...
- Bump github.com/cometbft/cometbft from 0.38.17 to 0.38.19 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
- Bump github.com/btcsuite/btcd from 0.22.1 to 0.24.2 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
- Bump github.com/consensys/gnark-crypto from 0.12.1 to 0.18.1 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
- Bump github.com/hashicorp/go-getter from 1.7.6 to 1.7.9 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
- Bump github.com/ulikunitz/xz from 0.5.12 to 0.5.14 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
- Bump golang.org/x/crypto from 0.32.0 to 0.35.0 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
- Bump golang.org/x/net from 0.34.0 to 0.35.0 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
- Bump golang.org/x/oauth2 from 0.25.0 to 0.27.0 ([#85](https://github.com/PreFrontalCorporate/gaia/pull/85))
