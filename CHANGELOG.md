...
- Bump `github.com/btcsuite/btcd` from 0.22.1 to 0.24.2 ([#23](https://github.com/PreFrontalCorporate/gaia/pull/23))
- Bump `golang.org/x/crypto` from 0.32.0 to 0.35.0 ([#23](https://github.com/PreFrontalCorporate/gaia/pull/23))
- Bump `golang.org/x/net` from 0.34.0 to 0.38.0 ([#23](https://github.com/PreFrontalCorporate/gaia/pull/23))
